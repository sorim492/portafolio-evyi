        ...
        <div className="contact" id="contact">
            ...
            <form>
               <div className="row">
                  <div className="col-6">
                     <h4>Your name</h4>
                     <input type="text" placeholder="Enter your name" className="contact-name" id="name" required/>
                  </div>
                  <div className="col-6">
                     <h4>Your email</h4>
                     <input type="email" placeholder="Enter your email" className="contact-email" id="email" required/>
                  </div>
               </div>
               <div className="row">
                  <div className="col-12">
                  <h4>Your Message</h4>
                     <input type="text" placeholder="Hi, we need you, we're Company X" className="contact-message" id="text" required/>
                  </div>
               </div>
               <br/>
